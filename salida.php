...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Verificar si existe un registro de entrada sin salida
    ...
    if ($entradas_sin_salida == 0) {
        $_SESSION['mensaje'] = "No hay un ingreso registrado. Debes registrar tu entrada antes de registrar una salida.";
    }
    else {
        try {
            ...
            $_SESSION['mensaje'] = "Error al registrar la salida: " . $e->getMessage();
        }
    }
...
<head>
    ...
    <title>Salida - Control de Asistencia</title>
...
<body>
    ...
    <main class="main-content">
        <div class="form-container">
            ...
            <h2 class="form-title">Registro de Salida</h2>

            <?php if (isset($error)): ?>
                <div class="alert alert-danger"><?php echo $error; ?></div>
            <?php endif; ?>

            <form id="formSalida" method="POST" action="salida.php">
                ...
                <div class="form-group">
                    <label for="fechaSalida"><i class="fas fa-calendar-alt mr-2"></i>Fecha de Salida</label>
                    <input type="date" class="form-control form-control-lg" id="fechaSalida" name="fechaSalida" required>
                </div>

                <div class="form-group">
                    <label><i class="fas fa-clock mr-2"></i>Hora de Salida</label>
                    <p class="form-control-plaintext form-control-lg hora-automatica" id="horaSalida">--:--:-- (Se registrará automáticamente)</p>
                </div>

                <button type="submit" class="btn btn-primary btn-lg btn-block mt-4 btn-salir">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function actualizarHora() {
                ...
                const horaDisplay = document.getElementById('horaSalida');
                if (horaDisplay) {
